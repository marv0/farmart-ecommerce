                                ...
                                <tr key={index} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-3 relative">
                                        ...
                                        {clickedItemIndex === index && (
                                            <div className="absolute z-20 top-full left-0 bg-white border border-gray-200 p-2 divide-y divide-gray-100 rounded shadow">
                                                <ul className="py-1" role="none">
                                                    ...
                                                    {user && user.user_type === 'farmer' && userOrder.status === 'pending' && (
                                                        <li>
                                                            <button 
